...
func (s *testIntegrationSuite5) TestChangingDBCharset(c *C) {
	...
	// Test changing charset of schema with uppercase name. See https://gitee.com/zhoujin826/goInception-plus/issues/19273.
...
func (s *testIntegrationSuite3) TestCreateTemporaryTable(c *C) {
	...
	// Engine type can be anyone, see https://gitee.com/zhoujin826/goInception-plus/issues/28541.
