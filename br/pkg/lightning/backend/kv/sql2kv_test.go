...
func (s *kvSuite) TestEncodeRowFormatV2(c *C) {
	// Test encoding in row format v2, as described in <https://gitee.com/zhoujin826/goInception-plus/blob/master/docs/design/2018-07-19-row-format.md>.
...
// Run `go test gitee.com/zhoujin826/goInception-plus/br/pkg/lightning/backend -check.b -test.v` to get benchmark result.
