...
import (
	...
	"gitee.com/zhoujin826/goInception-plus/store/gcworker"
...
PARTITION BY RANGE (c) (
	...
	failpoint.Enable("gitee.com/zhoujin826/goInception-plus/store/gcworker/ignoreDeleteRangeFailed", `return`)
	defer func() {
		failpoint.Disable("gitee.com/zhoujin826/goInception-plus/store/gcworker/ignoreDeleteRangeFailed")
	}()
