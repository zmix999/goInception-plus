...
**Please connect to GoInception-plus and use `inception show processlist `to make sure the process current stage before use KILL.**
...
### goInception-plus backup database kill (Absolutely not recommended)
