...
func TestSpillActionDeadLock(t *testing.T) {
	...
	require.Nil(t, failpoint.Enable("gitee.com/zhoujin826/goInception-plus/util/chunk/testRowContainerDeadLock", "return(true)"))
	defer func() {
		require.Nil(t, failpoint.Disable("gitee.com/zhoujin826/goInception-plus/util/chunk/testRowContainerDeadLock"))
	}()
	sz := 4
