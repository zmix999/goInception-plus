...
func TestTopology(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("gitee.com/zhoujin826/goInception-plus/domain/infosync/mockServerInfo", "return(true)"))
	defer func() {
		err := failpoint.Disable("gitee.com/zhoujin826/goInception-plus/domain/infosync/mockServerInfo")
