...
func (w *worker) doModifyColumnTypeWithData(
	...
	case model.StateWriteReorganization:
		...
		// enable: curl -X PUT -d "pause" "http://127.0.0.1:10080/fail/github.com/zmix999/goInception-plus/ddl/mockDelayInModifyColumnTypeWithData".
		// disable: curl -X DELETE "http://127.0.0.1:10080/fail/github.com/zmix999/goInception-plus/ddl/mockDelayInModifyColumnTypeWithData"
