...
func (s *testSerialSuite) TestIndexLookupMergeJoinHang(c *C) {
	c.Assert(failpoint.Enable("gitee.com/zhoujin826/goInception-plus/executor/IndexMergeJoinMockOOM", `return(true)`), IsNil)
	defer func() {
		c.Assert(failpoint.Disable("gitee.com/zhoujin826/goInception-plus/executor/IndexMergeJoinMockOOM"), IsNil)
	}()
...
func (s *testSerialSuite) TestIssue18068(c *C) {
	c.Assert(failpoint.Enable("gitee.com/zhoujin826/goInception-plus/executor/testIssue18068", `return(true)`), IsNil)
	defer func() {
		c.Assert(failpoint.Disable("gitee.com/zhoujin826/goInception-plus/executor/testIssue18068"), IsNil)
	}()
