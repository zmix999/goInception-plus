...
import (
	...
	mockTopSQLReporter "gitee.com/zhoujin826/goInception-plus/util/topsql/reporter/mock"
	"gitee.com/zhoujin826/goInception-plus/util/topsql/tracecpu"
	mockTopSQLTraceCPU "gitee.com/zhoujin826/goInception-plus/util/topsql/tracecpu/mock"
)
...
func (ts *tidbTestTopSQLSuite) TestTopSQLCPUProfile(c *C) {
	...
	c.Assert(failpoint.Enable("gitee.com/zhoujin826/goInception-plus/domain/skipLoadSysVarCacheLoop", `return(true)`), IsNil)
	c.Assert(failpoint.Enable("gitee.com/zhoujin826/goInception-plus/util/topsql/mockHighLoadForEachSQL", `return(true)`), IsNil)
	defer func() {
		err = failpoint.Disable("gitee.com/zhoujin826/goInception-plus/domain/skipLoadSysVarCacheLoop")
		c.Assert(err, IsNil)
		err = failpoint.Disable("gitee.com/zhoujin826/goInception-plus/util/topsql/mockHighLoadForEachSQL")
		c.Assert(err, IsNil)
	}()
...
func (ts *tidbTestTopSQLSuite) TestTopSQLAgent(c *C) {
	...
	c.Assert(failpoint.Enable("gitee.com/zhoujin826/goInception-plus/util/topsql/reporter/resetTimeoutForTest", `return(true)`), IsNil)
	c.Assert(failpoint.Enable("gitee.com/zhoujin826/goInception-plus/domain/skipLoadSysVarCacheLoop", `return(true)`), IsNil)
	c.Assert(failpoint.Enable("gitee.com/zhoujin826/goInception-plus/util/topsql/mockHighLoadForEachSQL", `return(true)`), IsNil)
	defer func() {
		err := failpoint.Disable("gitee.com/zhoujin826/goInception-plus/util/topsql/reporter/resetTimeoutForTest")
		c.Assert(err, IsNil)
		err = failpoint.Disable("gitee.com/zhoujin826/goInception-plus/domain/skipLoadSysVarCacheLoop")
		c.Assert(err, IsNil)
		err = failpoint.Disable("gitee.com/zhoujin826/goInception-plus/util/topsql/mockHighLoadForEachSQL")
