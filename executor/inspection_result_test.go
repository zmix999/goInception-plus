...
func (s *inspectionResultSuite) tearDownForInspection(c *C) {
	fpName := "gitee.com/zhoujin826/goInception-plus/executor/mockMergeMockInspectionTables"
	c.Assert(failpoint.Disable(fpName), IsNil)

	fpName2 := "gitee.com/zhoujin826/goInception-plus/executor/mockMetricsTableData"
...
func (s *inspectionResultSuite) TestCriticalErrorInspection(c *C) {
	...
	fpName2 := "gitee.com/zhoujin826/goInception-plus/executor/mockClusterLogServerInfo"
