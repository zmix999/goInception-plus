...
func (s *testSuiteJoinSerial) TestIndexNestedLoopHashJoin(c *C) {
	...
	c.Assert(failpoint.Enable("gitee.com/zhoujin826/goInception-plus/planner/core/MockOnlyEnableIndexHashJoin", "return(true)"), IsNil)
	defer func() {
		c.Assert(failpoint.Disable("gitee.com/zhoujin826/goInception-plus/planner/core/MockOnlyEnableIndexHashJoin"), IsNil)
	}()
	tk.MustExec("drop table t")
...
func (s *testSuiteJoinSerial) TestIssue18070(c *C) {
	...
	fpName := "gitee.com/zhoujin826/goInception-plus/executor/mockIndexMergeJoinOOMPanic"
...
func (s *testSuiteJoinSerial) TestIssue18572_1(c *C) {
	...
	c.Assert(failpoint.Enable("gitee.com/zhoujin826/goInception-plus/executor/testIndexHashJoinInnerWorkerErr", "return"), IsNil)
	defer func() {
		c.Assert(failpoint.Disable("gitee.com/zhoujin826/goInception-plus/executor/testIndexHashJoinInnerWorkerErr"), IsNil)
	}()
...
func (s *testSuiteJoinSerial) TestIssue18572_2(c *C) {
	...
	c.Assert(failpoint.Enable("gitee.com/zhoujin826/goInception-plus/executor/testIndexHashJoinOuterWorkerErr", "return"), IsNil)
	defer func() {
		c.Assert(failpoint.Disable("gitee.com/zhoujin826/goInception-plus/executor/testIndexHashJoinOuterWorkerErr"), IsNil)
	}()
...
func (s *testSuiteJoinSerial) TestIssue18572_3(c *C) {
	...
	c.Assert(failpoint.Enable("gitee.com/zhoujin826/goInception-plus/executor/testIndexHashJoinBuildErr", "return"), IsNil)
	defer func() {
		c.Assert(failpoint.Disable("gitee.com/zhoujin826/goInception-plus/executor/testIndexHashJoinBuildErr"), IsNil)
	}()
...
func (s *testSuiteJoinSerial) TestIssue20270(c *C) {
	tk := testkit.NewTestKitWithInit(c, s.store)
	err := failpoint.Enable("gitee.com/zhoujin826/goInception-plus/executor/killedInJoin2Chunk", "return(true)")
	c.Assert(err, IsNil)
	tk.MustExec("drop table if exists t;")
	tk.MustExec("drop table if exists t1;")
	tk.MustExec("create table t(c1 int, c2 int)")
	...
	err = failpoint.Disable("gitee.com/zhoujin826/goInception-plus/executor/killedInJoin2Chunk")
	c.Assert(err, IsNil)
	plannercore.ForceUseOuterBuild4Test = true
	defer func() {
		plannercore.ForceUseOuterBuild4Test = false
	}()
	err = failpoint.Enable("gitee.com/zhoujin826/goInception-plus/executor/killedInJoin2ChunkForOuterHashJoin", "return(true)")
	c.Assert(err, IsNil)
	...
	c.Assert(err, Equals, executor.ErrQueryInterrupted)
	err = failpoint.Disable("gitee.com/zhoujin826/goInception-plus/executor/killedInJoin2ChunkForOuterHashJoin")
	c.Assert(err, IsNil)
}
...
func (s *testSuiteJoinSerial) TestIssue20779(c *C) {
	...
	c.Assert(failpoint.Enable("gitee.com/zhoujin826/goInception-plus/executor/testIssue20779", "return"), IsNil)
	defer func() {
		c.Assert(failpoint.Disable("gitee.com/zhoujin826/goInception-plus/executor/testIssue20779"), IsNil)
	}()
...
func (s *testSuiteJoinSerial) TestIssue30211(c *C) {
	...
	tk.MustExec("create table t2(a int, index(a));")
	func() {
		fpName := "gitee.com/zhoujin826/goInception-plus/executor/TestIssue30211"
