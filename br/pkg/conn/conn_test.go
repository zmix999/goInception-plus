...
func TestGetAllTiKVStoresWithRetryCancel(t *testing.T) {
	_ = failpoint.Enable("gitee.com/zhoujin826/goInception-plus/br/pkg/conn/hint-GetAllTiKVStores-cancel", "return(true)")
	defer func() {
		_ = failpoint.Disable("gitee.com/zhoujin826/goInception-plus/br/pkg/conn/hint-GetAllTiKVStores-cancel")
	}()
...
func TestGetAllTiKVStoresWithUnknown(t *testing.T) {
	_ = failpoint.Enable("gitee.com/zhoujin826/goInception-plus/br/pkg/conn/hint-GetAllTiKVStores-error", "return(true)")
	defer func() {
		_ = failpoint.Disable("gitee.com/zhoujin826/goInception-plus/br/pkg/conn/hint-GetAllTiKVStores-error")
	}()
	ctx, cancel := context.WithCancel(context.Background())
	defer cancel()
