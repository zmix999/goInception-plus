...
func DBFromConfig(ctx context.Context, dsn config.DBStore) (*sql.DB, error) {
	...
	vars := map[string]string{
		...
		// after https://gitee.com/zhoujin826/goInception-plus/pull/17102 merge,
...
// See: https://gitee.com/zhoujin826/goInception-plus/blob/64698ef9a3358bfd0fdc323996bb7928a56cadca/ddl/ddl_api.go#L2528-L2533
