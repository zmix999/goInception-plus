...
import (
	...
	decoder "gitee.com/zhoujin826/goInception-plus/util/rowDecoder"
...
func (w *worker) doModifyColumnTypeWithData(
	...
	case model.StateWriteReorganization:
		...
		// enable: curl -X PUT -d "pause" "http://127.0.0.1:10080/fail/gitee.com/zhoujin826/goInception-plus/ddl/mockDelayInModifyColumnTypeWithData".
		// disable: curl -X DELETE "http://127.0.0.1:10080/fail/gitee.com/zhoujin826/goInception-plus/ddl/mockDelayInModifyColumnTypeWithData"
