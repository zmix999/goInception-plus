...
// https://gitee.com/zhoujin826/goInception-plus/pull/6249 fixes the following two test cases.
...
func (s *serialTestStateChangeSuite) TestModifyColumnTypeArgs(c *C) {
	c.Assert(failpoint.Enable("gitee.com/zhoujin826/goInception-plus/ddl/mockUpdateVersionAndTableInfoErr", `return(2)`), IsNil)
	defer func() {
		c.Assert(failpoint.Disable("gitee.com/zhoujin826/goInception-plus/ddl/mockUpdateVersionAndTableInfoErr"), IsNil)
	}()
