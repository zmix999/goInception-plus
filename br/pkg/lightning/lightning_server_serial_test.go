...
func createSuite(t *testing.T) (s *lightningServerSuite, clean func()) {
	...
	require.NoError(t, failpoint.Enable("gitee.com/zhoujin826/goInception-plus/br/pkg/lightning/SkipRunTask", "return"))
	clean = func() {
		require.NoError(t, failpoint.Disable("gitee.com/zhoujin826/goInception-plus/br/pkg/lightning/SkipRunTask"))
		s.lightning.Stop()
	}
