...
func (s *testSessionSerialSuite) TestFailStatementCommitInRetry(c *C) {
	...
	c.Assert(failpoint.Enable("gitee.com/zhoujin826/goInception-plus/session/mockCommitError8942", `return(true)`), IsNil)
	_, err := tk.Exec("commit")
	c.Assert(err, NotNil)
	c.Assert(failpoint.Disable("gitee.com/zhoujin826/goInception-plus/session/mockCommitError8942"), IsNil)
...
func (s *testSessionSerialSuite) TestGetTSFailDirtyStateInretry(c *C) {
	defer func() {
		c.Assert(failpoint.Disable("gitee.com/zhoujin826/goInception-plus/session/mockCommitError"), IsNil)
	...
	c.Assert(failpoint.Enable("gitee.com/zhoujin826/goInception-plus/session/mockCommitError", `return(true)`), IsNil)
