...
import (
	...
	tmysql "gitee.com/zhoujin826/goInception-plus/errno"
...
func (s *testIntegrationSuite3) TestCreateTableWithPartition(c *C) {
	...
	// Fix a timezone dependent check bug introduced in https://gitee.com/zhoujin826/goInception-plus/pull/10655
	...
	// Fix https://gitee.com/zhoujin826/goInception-plus/issues/16333
...
func (s *testSerialDBSuite1) TestAddPartitionReplicaBiggerThanTiFlashStores(c *C) {
	...
	c.Assert(failpoint.Disable("gitee.com/zhoujin826/goInception-plus/infoschema/mockTiFlashStoreCount"), IsNil)
	...
	c.Assert(failpoint.Enable("gitee.com/zhoujin826/goInception-plus/ddl/mockWaitTiFlashReplica", `return(true)`), IsNil)
	defer func() {
		c.Assert(failpoint.Disable("gitee.com/zhoujin826/goInception-plus/ddl/mockWaitTiFlashReplica"), IsNil)
	}()
	c.Assert(t1.Meta().TiFlashReplica.Available, IsTrue)
