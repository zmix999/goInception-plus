...
import (
	...
	ddltestutil "gitee.com/zhoujin826/goInception-plus/ddl/testutil"
...
func TestEarlyClose(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("gitee.com/zhoujin826/goInception-plus/store/copr/handleTaskOnceError", `return(true)`))
	defer func() {
		require.NoError(t, failpoint.Disable("gitee.com/zhoujin826/goInception-plus/store/copr/handleTaskOnceError"))
	}()
...
func TestShow(t *testing.T) {
	...
	row := result.Rows()[0]
	// For issue https://gitee.com/zhoujin826/goInception-plus/issues/1061
	...
	// For issue https://gitee.com/zhoujin826/goInception-plus/issues/1918
	...
	// for issue https://gitee.com/zhoujin826/goInception-plus/issues/4224
	...
	// for issue https://gitee.com/zhoujin826/goInception-plus/issues/3747
	...
	// for issue https://gitee.com/zhoujin826/goInception-plus/issues/4678
	...
	// for issue https://gitee.com/zhoujin826/goInception-plus/issues/4411
	...
	// for issue https://gitee.com/zhoujin826/goInception-plus/issues/4424
	...
	// for issue https://gitee.com/zhoujin826/goInception-plus/issues/4425
	tk.MustExec("drop table if exists show_test")
	testSQL = `create table show_test(
	...
	// for issue https://gitee.com/zhoujin826/goInception-plus/issues/4426
	tk.MustExec("drop table if exists show_test")
	testSQL = `create table show_test(
		a bit(1),
...
func TestIndexMergeReaderClose(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("gitee.com/zhoujin826/goInception-plus/executor/startPartialIndexWorkerErr", "return"))
	err := tk.QueryToErr("select /*+ USE_INDEX_MERGE(t, idx1, idx2) */ * from t where a > 10 or b < 100")
	require.NoError(t, failpoint.Disable("gitee.com/zhoujin826/goInception-plus/executor/startPartialIndexWorkerErr"))
	require.Error(t, err)
...
func TestParallelHashAggClose(t *testing.T) {
	...
	// Goroutine should not leak when error happen.
	require.NoError(t, failpoint.Enable("gitee.com/zhoujin826/goInception-plus/executor/parallelHashAggError", `return(true)`))
	defer func() {
		require.NoError(t, failpoint.Disable("gitee.com/zhoujin826/goInception-plus/executor/parallelHashAggError"))
	}()
	ctx := context.Background()
...
func TestUnparallelHashAggClose(t *testing.T) {
	...
	// Goroutine should not leak when error happen.
	require.NoError(t, failpoint.Enable("gitee.com/zhoujin826/goInception-plus/executor/unparallelHashAggError", `return(true)`))
	defer func() {
		require.NoError(t, failpoint.Disable("gitee.com/zhoujin826/goInception-plus/executor/unparallelHashAggError"))
	}()
	ctx := context.Background()
...
func HelperTestAdminShowNextID(t *testing.T, store kv.Storage, str string) {
	require.NoError(t, failpoint.Enable("gitee.com/zhoujin826/goInception-plus/meta/autoid/mockAutoIDChange", `return(true)`))
	defer func() {
		require.NoError(t, failpoint.Disable("gitee.com/zhoujin826/goInception-plus/meta/autoid/mockAutoIDChange"))
	}()
	step := int64(10)
	autoIDStep := autoid.GetStep()
	autoid.SetStep(step)
...
func TestNoHistoryWhenDisableRetry(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("gitee.com/zhoujin826/goInception-plus/session/keepHistory", `return(true)`))
	tk.MustExec("insert history values (1)")
	require.Equal(t, 1, session.GetHistory(tk.Session()).Count())
	require.NoError(t, failpoint.Disable("gitee.com/zhoujin826/goInception-plus/session/keepHistory"))
	tk.MustExec("begin")
	tk.MustExec("insert history values (1)")
	require.Equal(t, 0, session.GetHistory(tk.Session()).Count())
	tk.MustExec("commit")
...
func TestAutoIncIDInRetry(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("gitee.com/zhoujin826/goInception-plus/session/mockCommitRetryForAutoIncID", `return(true)`))
	tk.MustExec("commit")
	require.NoError(t, failpoint.Disable("gitee.com/zhoujin826/goInception-plus/session/mockCommitRetryForAutoIncID"))
...
func TestAutoRandIDRetry(t *testing.T) {
	...
	fpName := "gitee.com/zhoujin826/goInception-plus/session/mockCommitRetryForAutoRandID"
...
func TestOOMPanicInHashJoinWhenFetchBuildRows(t *testing.T) {
	...
	fpName := "gitee.com/zhoujin826/goInception-plus/executor/errorFetchBuildSideRowsMockOOMPanic"
...
func TestIssue18744(t *testing.T) {
  ...
  KEY f (f)
	...
	require.NoError(t, failpoint.Enable("gitee.com/zhoujin826/goInception-plus/executor/testIndexHashJoinOuterWorkerErr", "return"))
	defer func() {
		require.NoError(t, failpoint.Disable("gitee.com/zhoujin826/goInception-plus/executor/testIndexHashJoinOuterWorkerErr"))
	}()
...
func TestAnalyzeNextRawErrorNoLeak(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("gitee.com/zhoujin826/goInception-plus/distsql/mockNextRawError", `return(true)`))
