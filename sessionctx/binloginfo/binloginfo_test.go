...
func createBinlogSuite(t *testing.T) (s *binlogSuite, clean func()) {
	require.NoError(t, failpoint.Enable("gitee.com/zhoujin826/goInception-plus/store/driver/txn/mockSyncBinlogCommit", `return(true)`))
	...
	clean = func() {
		...
		cleanStore()
		require.NoError(t, failpoint.Disable("gitee.com/zhoujin826/goInception-plus/store/driver/txn/mockSyncBinlogCommit"))
	}
