...
goInception-plus run by `./goInception-plus -config=config/config.toml`, this document show the detail of the configuration file.

**goInception-plus based on some TiDB source code, so some config parameters can check TiDB documents**
