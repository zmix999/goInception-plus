...
import (
	...
	"gitee.com/zhoujin826/goInception-plus/br/pkg/lightning/backend"
	"gitee.com/zhoujin826/goInception-plus/br/pkg/lightning/backend/importer"
	"gitee.com/zhoujin826/goInception-plus/br/pkg/lightning/backend/kv"
	"gitee.com/zhoujin826/goInception-plus/br/pkg/lightning/backend/noop"
	"gitee.com/zhoujin826/goInception-plus/br/pkg/lightning/backend/tidb"
	"gitee.com/zhoujin826/goInception-plus/br/pkg/lightning/checkpoints"
	"gitee.com/zhoujin826/goInception-plus/br/pkg/lightning/common"
	"gitee.com/zhoujin826/goInception-plus/br/pkg/lightning/config"
	"gitee.com/zhoujin826/goInception-plus/br/pkg/lightning/errormanager"
	"gitee.com/zhoujin826/goInception-plus/br/pkg/lightning/glue"
	"gitee.com/zhoujin826/goInception-plus/br/pkg/lightning/log"
	"gitee.com/zhoujin826/goInception-plus/br/pkg/lightning/metric"
	"gitee.com/zhoujin826/goInception-plus/br/pkg/lightning/mydump"
	"gitee.com/zhoujin826/goInception-plus/br/pkg/lightning/verification"
	"gitee.com/zhoujin826/goInception-plus/br/pkg/lightning/web"
	"gitee.com/zhoujin826/goInception-plus/br/pkg/lightning/worker"
	...
	tmock "gitee.com/zhoujin826/goInception-plus/util/mock"
...
func (s *tableRestoreSuite) TestPopulateChunks(c *C) {
	_ = failpoint.Enable("gitee.com/zhoujin826/goInception-plus/br/pkg/lightning/restore/PopulateChunkTimestamp", "return(1234567897)")
	defer func() {
		_ = failpoint.Disable("gitee.com/zhoujin826/goInception-plus/br/pkg/lightning/restore/PopulateChunkTimestamp")
	}()
...
func (s *tableRestoreSuite) TestSaveStatusCheckpoint(c *C) {
	_ = failpoint.Enable("gitee.com/zhoujin826/goInception-plus/br/pkg/lightning/restore/SlowDownCheckpointUpdate", "sleep(100)")
	defer func() {
		_ = failpoint.Disable("gitee.com/zhoujin826/goInception-plus/br/pkg/lightning/restore/SlowDownCheckpointUpdate")
	}()
...
func (s *chunkRestoreSuite) TestEncodeLoopDeliverLimit(c *C) {
	...
	c.Assert(failpoint.Enable(
		"gitee.com/zhoujin826/goInception-plus/br/pkg/lightning/restore/mock-kv-size", "return(110000000)"), IsNil)
	_, _, err = s.cr.encodeLoop(ctx, kvsCh, s.tr, s.tr.logger, kvEncoder, deliverCompleteCh, rc)
	c.Assert(err, IsNil)
