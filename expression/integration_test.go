...
func (s *testIntegrationSuite2) TestTimeBuiltin(c *C) {
	...
	// Issue https://gitee.com/zhoujin826/goInception-plus/issues/20003
...
func (s *testIntegrationSuite2) TestBuiltin(c *C) {
	...
	// Issue https://gitee.com/zhoujin826/goInception-plus/issues/19986
	...
	result.Check(nil)
	// Issue https://gitee.com/zhoujin826/goInception-plus/issues/19999
	...
	result.Check(nil)
	// Issue https://gitee.com/zhoujin826/goInception-plus/issues/20001
	...
	// for regexp, rlike
	// https://gitee.com/zhoujin826/goInception-plus/issues/4080
	tk.MustExec(`drop table if exists t;`)
...
func (s *testIntegrationSuite) TestTiDBInternalFunc(c *C) {
	...
	// https://gitee.com/zhoujin826/goInception-plus/issues/27434.
...
func (s *testIntegrationSuite) TestIssue11309And11319(c *C) {
	...
	// for https://gitee.com/zhoujin826/goInception-plus/issues/11319
...
PARTITION BY RANGE (c) (
	...
	testcases := []struct {
		...
		// FIXME: block by https://gitee.com/zhoujin826/goInception-plus/issues/21872
		//{
		...
		//},
		// FIXME: block by https://gitee.com/zhoujin826/goInception-plus/issues/21847
		//{
...
// See: https://gitee.com/zhoujin826/goInception-plus/issues/24368
...
// issue https://gitee.com/zhoujin826/goInception-plus/issues/26111
