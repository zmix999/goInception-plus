...
import (
	...
	testddlutil "gitee.com/zhoujin826/goInception-plus/ddl/testutil"
...
func (s *testSerialDBSuite) TestDropTableOnTiKVDiskFull(c *C) {
	...
	c.Assert(failpoint.Enable("gitee.com/zhoujin826/goInception-plus/store/mockstore/unistore/rpcTiKVAllowedOnAlmostFull", `return(true)`), IsNil)
	defer failpoint.Disable("gitee.com/zhoujin826/goInception-plus/store/mockstore/unistore/rpcTiKVAllowedOnAlmostFull")
...
func (s *testDBSuite4) TestChangeColumn(c *C) {
	...
	// https://gitee.com/zhoujin826/goInception-plus/issues/23488
...
func (s *testSerialDBSuite) TestCreateTableWithLike2(c *C) {
	...
	c.Assert(failpoint.Enable("gitee.com/zhoujin826/goInception-plus/infoschema/mockTiFlashStoreCount", `return(true)`), IsNil)
	defer func() {
		err := failpoint.Disable("gitee.com/zhoujin826/goInception-plus/infoschema/mockTiFlashStoreCount")
		c.Assert(err, IsNil)
	}()
...
func (s *testSerialDBSuite) TestRepairTable(c *C) {
	c.Assert(failpoint.Enable("gitee.com/zhoujin826/goInception-plus/infoschema/repairFetchCreateTable", `return(true)`), IsNil)
	defer func() {
		c.Assert(failpoint.Disable("gitee.com/zhoujin826/goInception-plus/infoschema/repairFetchCreateTable"), IsNil)
	}()
	tk := testkit.NewTestKit(c, s.store)
	tk.MustExec("use test")
...
func (s *testSerialDBSuite) TestModifyColumnReorgInfo(c *C) {
	...
	c.Assert(failpoint.Enable("gitee.com/zhoujin826/goInception-plus/ddl/MockGetIndexRecordErr", `return("cantDecodeRecordErr")`), IsNil)
	s.dom.DDL().(ddl.DDLForTest).SetHook(hook)
	_, err := tk.Exec(sql)
	...
	c.Assert(failpoint.Disable("gitee.com/zhoujin826/goInception-plus/ddl/MockGetIndexRecordErr"), IsNil)
	tk.MustExec("admin check table t1")
	...
	c.Assert(failpoint.Enable("gitee.com/zhoujin826/goInception-plus/ddl/MockGetIndexRecordErr", `return("modifyColumnNotOwnerErr")`), IsNil)
	tk.MustExec(sql)
	expectedEles = []*meta.Element{
	...
	c.Assert(failpoint.Enable("gitee.com/zhoujin826/goInception-plus/ddl/MockGetIndexRecordErr", `return("addIdxNotOwnerErr")`), IsNil)
...
func (s *testSerialDBSuite) TestModifyColumnNullToNotNullWithChangingVal2(c *C) {
	...
	c.Assert(failpoint.Enable("gitee.com/zhoujin826/goInception-plus/ddl/mockInsertValueAfterCheckNull", `return("insert into test.tt values (NULL, NULL)")`), IsNil)
	defer func() {
		err := failpoint.Disable("gitee.com/zhoujin826/goInception-plus/ddl/mockInsertValueAfterCheckNull")
		c.Assert(err, IsNil)
	}()
...
func testAddIndexForGeneratedColumn(tk *testkit.TestKit, s *testDBSuite5, c *C) {
	...
	// TODO: Fix bug https://gitee.com/zhoujin826/goInception-plus/issues/12181
...
func (s *testSerialDBSuite) TestDDLJobErrorCount(c *C) {
	...
	c.Assert(failpoint.Enable("gitee.com/zhoujin826/goInception-plus/ddl/mockErrEntrySizeTooLarge", `return(true)`), IsNil)
	defer func() {
		c.Assert(failpoint.Disable("gitee.com/zhoujin826/goInception-plus/ddl/mockErrEntrySizeTooLarge"), IsNil)
	}()
...
func (s *testSerialDBSuite) TestAddIndexFailOnCaseWhenCanExit(c *C) {
	c.Assert(failpoint.Enable("gitee.com/zhoujin826/goInception-plus/ddl/MockCaseWhenParseFailure", `return(true)`), IsNil)
	defer func() {
		c.Assert(failpoint.Disable("gitee.com/zhoujin826/goInception-plus/ddl/MockCaseWhenParseFailure"), IsNil)
	}()
	tk := testkit.NewTestKit(c, s.store)
...
func (s *testSerialDBSuite) TestModifyColumnTypeWhenInterception(c *C) {
	...
	d.(ddl.DDLForTest).SetHook(hook)
	defer d.(ddl.DDLForTest).SetHook(originHook)
	c.Assert(failpoint.Enable("gitee.com/zhoujin826/goInception-plus/ddl/MockReorgTimeoutInOneRegion", `return(true)`), IsNil)
	defer func() {
		c.Assert(failpoint.Disable("gitee.com/zhoujin826/goInception-plus/ddl/MockReorgTimeoutInOneRegion"), IsNil)
	}()
...
// Close issue #23321.
// See https://gitee.com/zhoujin826/goInception-plus/issues/23321
func (s *testSerialDBSuite) TestJsonUnmarshalErrWhenPanicInCancellingPath(c *C) {
	...
	c.Assert(failpoint.Enable("gitee.com/zhoujin826/goInception-plus/ddl/mockExceedErrorLimit", `return(true)`), IsNil)
	defer c.Assert(failpoint.Disable("gitee.com/zhoujin826/goInception-plus/ddl/mockExceedErrorLimit"), IsNil)
...
// see https://gitee.com/zhoujin826/goInception-plus/issues/24288
...
// Close issue #24580.
// See https://gitee.com/zhoujin826/goInception-plus/issues/24580
...
// Close issue #27862 https://gitee.com/zhoujin826/goInception-plus/issues/27862
