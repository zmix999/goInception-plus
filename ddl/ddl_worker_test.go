...
func (s *testDDLSerialSuite) TestCancelJob(c *C) {
	...
	c.Assert(failpoint.Enable("gitee.com/zhoujin826/goInception-plus/ddl/skipMockContextDoExec", `return(true)`), IsNil)
	...
	c.Assert(failpoint.Disable("gitee.com/zhoujin826/goInception-plus/ddl/skipMockContextDoExec"), IsNil)
