...
var (
	...
	ErrInvalidDDLState = dbterror.ClassDDL.NewStdErr(mysql.ErrInvalidDDLState, parser_mysql.Message(fmt.Sprintf("%s", mysql.MySQLErrName[mysql.ErrInvalidDDLState].Raw), nil))
