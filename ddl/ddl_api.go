...
import (
	...
	field_types "gitee.com/zhoujin826/goInception-plus/parser/types"
...
func (d *ddl) getModifiableColumnJob(ctx context.Context, sctx sessionctx.Context, ident ast.Ident, originalColName model.CIStr,
	...
	newCol := table.ToColumn(&model.ColumnInfo{
		ID: col.ID,
		// We use this PR(https://gitee.com/zhoujin826/goInception-plus/pull/6274) as the dividing line to define whether it is a new version or an old version TiDB.
