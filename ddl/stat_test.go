...
func (s *testSerialStatSuite) TestDDLStatsInfo(c *C) {
	...
	c.Assert(failpoint.Enable("gitee.com/zhoujin826/goInception-plus/ddl/checkBackfillWorkerNum", `return(true)`), IsNil)
	defer func() {
		c.Assert(failpoint.Disable("gitee.com/zhoujin826/goInception-plus/ddl/checkBackfillWorkerNum"), IsNil)
	}()
