...
func (s *testColumnTypeChangeSuite) TestColumnTypeChangeBetweenVarcharAndNonVarchar(c *C) {
	...
	// https://gitee.com/zhoujin826/goInception-plus/issues/23624
	tk.MustExec("drop table if exists t;")
	...
	// https://gitee.com/zhoujin826/goInception-plus/pull/23688#issuecomment-810166597
	tk.MustExec("drop table if exists t;")
...
// Close https://gitee.com/zhoujin826/goInception-plus/issues/24839.
...
func (s *testColumnTypeChangeSuite) TestDDLExitWhenCancelMeetPanic(c *C) {
	...
	failpoint.Enable("gitee.com/zhoujin826/goInception-plus/ddl/mockExceedErrorLimit", `return(true)`)
	defer func() {
		failpoint.Disable("gitee.com/zhoujin826/goInception-plus/ddl/mockExceedErrorLimit")
	}()
...
func (s *testColumnTypeChangeSuite) TestCancelCTCInReorgStateWillCauseGoroutineLeak(c *C) {
	...
	failpoint.Enable("gitee.com/zhoujin826/goInception-plus/ddl/mockInfiniteReorgLogic", `return(true)`)
	defer func() {
		failpoint.Disable("gitee.com/zhoujin826/goInception-plus/ddl/mockInfiniteReorgLogic")
	}()
...
// Fix issue https://gitee.com/zhoujin826/goInception-plus/issues/25469
...
// Fix issue: https://gitee.com/zhoujin826/goInception-plus/issues/26292
...
// https://gitee.com/zhoujin826/goInception-plus/issues/25282.
...
// See https://gitee.com/zhoujin826/goInception-plus/issues/25287.
