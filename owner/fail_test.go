...
func TestFailNewSession(t *testing.T) {
	...
	func() {
		...
		defer func() {
			...
			require.NoError(t, failpoint.Disable("gitee.com/zhoujin826/goInception-plus/owner/closeClient"))
		}()
		require.NoError(t, failpoint.Enable("gitee.com/zhoujin826/goInception-plus/owner/closeClient", `return(true)`))
	...
	func() {
		...
		defer func() {
			...
			require.NoError(t, failpoint.Disable("gitee.com/zhoujin826/goInception-plus/owner/closeGrpc"))
		}()
		require.NoError(t, failpoint.Enable("gitee.com/zhoujin826/goInception-plus/owner/closeGrpc", `return(true)`))
