...
func TestPDRequestRetry(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("gitee.com/zhoujin826/goInception-plus/br/pkg/pdutil/FastRetry", "return(true)"))
	defer func() {
		require.NoError(t, failpoint.Disable("gitee.com/zhoujin826/goInception-plus/br/pkg/pdutil/FastRetry"))
	}()
