...
// See https://gitee.com/zhoujin826/goInception-plus/issues/19136
func (s *testSuite7) TestForApplyAndUnionScan(c *C) {
	...
	// See https://gitee.com/zhoujin826/goInception-plus/issues/19435
	...
	// See https://gitee.com/zhoujin826/goInception-plus/issues/19431
	tk.MustExec("DROP TABLE IF EXISTS `t`")
