...
import (
	...
	"github.com/zmix999/goInception-plus/store/gcworker"
	...
	"github.com/zmix999/goInception-plus/util/gcutil"
...
func (t *tikvHandlerTool) getMvccByIdxValue(idx table.Index, values url.Values, idxCols []*model.ColumnInfo, handle kv.Handle) (*helper.MvccKV, error) {
	...
	// See https://github.com/zmix999/goInception-plus/blob/master/docs/tidb_http_api.md for more details.
	sc.TimeZone = time.UTC
