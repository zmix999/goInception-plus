...
func TestStmtSummaryTable(t *testing.T) {
	...
	// Test SELECT.
	const failpointName = "gitee.com/zhoujin826/goInception-plus/planner/core/mockPlanRowCount"
...
func TestSimpleStmtSummaryEvictedCount(t *testing.T) {
	...
	tk.MustExec("set @@global.tidb_enable_stmt_summary=1")
	historySize := 24
	fpPath := "gitee.com/zhoujin826/goInception-plus/util/stmtsummary/mockTimeForStatementsSummary"
...
func TestTiDBTrx(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("gitee.com/zhoujin826/goInception-plus/expression/sqlDigestRetrieverSkipRetrieveGlobal", "return"))
	defer func() {
		require.NoError(t, failpoint.Disable("gitee.com/zhoujin826/goInception-plus/expression/sqlDigestRetrieverSkipRetrieveGlobal"))
	}()
...
func TestAttributes(t *testing.T) {
	...
	fpName := "gitee.com/zhoujin826/goInception-plus/executor/mockOutputOfAttributes"
	tk := newTestKitWithRoot(t, store)
