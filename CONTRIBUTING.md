...
# or: git remote add upstream git@gitee.com:zhoujin826/goInception-plus.git
...
chmod +x $working_dir/goInception-plus/.git/hooks/pre-commit
```
...
*The branch needs to be merged with the latest version of goInception-plus before submitting, so as not to be unable to merge PR*
...
1. Visit your fork at `https://gitee.com/$user/goInception-plus`.
